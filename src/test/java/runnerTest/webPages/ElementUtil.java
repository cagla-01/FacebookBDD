...
public class ElementUtil {
    ...
    public static WebElement webAction(final By locator){
        Wait<WebDriver>wait = new FluentWait<WebDriver>(BasePage.get())
                ...
                .withMessage(
                        "Webdriver waited for 15 seconds not still could not find the element therefore TimeOutException occured"
                );
    ...
    /**
     * scrolldown by element
     * @param locator
     */
    public void scrollByElementMethod(By locator){
    ...
    /**
     * get Screen Shot if your test is failed
     * @param name
     * @return
     */
